...
rooms = {
    'First Room': {
        'Forward': 'Second Room', 
        'Prompt': "You walk into a dark room. There is a " + colour.GREEN + "child" + colour.END + " standing in front of you. The " + colour.GREEN + "child" + colour.END + " is crying.",
        'Item': None,
        'Character': 'child',
        'Dialogue': [
            ...
            '“Please find it for me. (sniffles)”',
            '“Really? You\'ll find it? Thank you!”'
        ],
    ...
    'Second Room': {
        'Forward': 'Third Room', 
        'Back': 'First Room', 
        'Prompt': "There is a " + colour.GREEN + "girl" + colour.END + " sitting in front of you. She is ripping off the petals of a scorpion grass "  + colour.CYAN + "flower" + colour.END + ". She's surrounded by hundreds - no, thousands of them. She\'s your first love. All of a sudden, you're 15, and you haven\'t felt this nervous in years.",
        'Item': 'flower',
        'Character': 'girl',
        'Dialogue': [
    ...
    'Third Room': {
        'Forward': 'Final Room', 
        'Back': 'Second Room', 
        'Prompt': "A rugged looking " + colour.GREEN + "man" + colour.END + ", much older in age, sits in front of you on a chair. He stares at you through the thick of his eyebrows.\nA rusty " + colour.CYAN + "shovel" + colour.END + " lays on the ground in front of you, the light reflecting off the tiny speck of silver that remains unadulterated.",
        'Item': 'shovel',
        'Character': 'man',
        'Dialogue': [
        ...
        'DigMessage': "You heaved the shovel at the ground beneath your feet and threw the earth over your shoulder."
    },
    'Final Room': {
